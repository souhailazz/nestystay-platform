...
test("99 canonical screens and 55 aliases render from the canonical manifest", async ({ page }, testInfo) => {
  ...
  expect(cases.filter((item) => item.kind === "alias")).toHaveLength(55);
