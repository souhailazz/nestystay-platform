...
<img alt={`${property.title} preview`} className="block h-[76px] w-24 shrink-0 rounded-[12px] object-cover" height={76} loading="lazy" src={property.imageUrl ?? property.galleryUrls?.[0] ?? getStayImage(0).src} width={96} />
