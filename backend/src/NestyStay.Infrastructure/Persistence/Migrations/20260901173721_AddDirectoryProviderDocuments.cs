...
{
    /// <inheritdoc />
    public partial class AddDirectoryProviderDocuments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "milestone_directory_provider_document",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_milestone_directory_provider_document", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_milestone_directory_provider_document_object_key",
                table: "milestone_directory_provider_document",
                column: "object_key",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_milestone_directory_provider_document_provider_id_owner_use~",
                table: "milestone_directory_provider_document",
                columns: new[] { "provider_id", "owner_user_id", "status" });
        }
