...
{
    /// <inheritdoc />
    public partial class AddMilestonePropertyPhotos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "milestone_property_photo",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_milestone_property_photo", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_milestone_property_photo_object_key",
                table: "milestone_property_photo",
                column: "object_key",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_milestone_property_photo_property_id_host_user_id_status",
                table: "milestone_property_photo",
                columns: new[] { "property_id", "host_user_id", "status" });
        }
