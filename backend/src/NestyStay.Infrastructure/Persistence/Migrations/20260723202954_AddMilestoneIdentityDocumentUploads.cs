...
{
    /// <inheritdoc />
    public partial class AddMilestoneIdentityDocumentUploads : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "milestone_identity_document_upload",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    user_id = table.Column<Guid>(type: "uuid", nullable: false),
                    identity_document_id = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    issuing_country = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_milestone_identity_document_upload", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_milestone_identity_document_upload_identity_document_id",
                table: "milestone_identity_document_upload",
                column: "identity_document_id");

            migrationBuilder.CreateIndex(
                name: "IX_milestone_identity_document_upload_object_key",
                table: "milestone_identity_document_upload",
                column: "object_key",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_milestone_identity_document_upload_user_id_status",
                table: "milestone_identity_document_upload",
