...
{
    /// <inheritdoc />
    public partial class AddMilestoneWellnessReportPhotos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "milestone_wellness_report_photo",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_milestone_wellness_report_photo", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_milestone_wellness_report_photo_object_key",
                table: "milestone_wellness_report_photo",
                column: "object_key",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_milestone_wellness_report_photo_report_id",
                table: "milestone_wellness_report_photo",
                column: "report_id");

            migrationBuilder.CreateIndex(
                name: "IX_milestone_wellness_report_photo_visit_id_officer_id_status",
                table: "milestone_wellness_report_photo",
                columns: new[] { "visit_id", "officer_id", "status" });
        }
