...
{
    /// <inheritdoc />
    public partial class AddMilestoneAdminCaseEvidenceUploads : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "milestone_admin_case_evidence",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_milestone_admin_case_evidence", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_milestone_admin_case_evidence_case_id_status",
                table: "milestone_admin_case_evidence",
                columns: new[] { "case_id", "status" });

            migrationBuilder.CreateIndex(
                name: "IX_milestone_admin_case_evidence_object_key",
                table: "milestone_admin_case_evidence",
                column: "object_key",
                unique: true);
        }
