...
public static class EmailTemplateCatalog
{
    private static readonly IReadOnlyDictionary<string, EmailTemplate> Templates =
        ...
        {
            ["passwordless-login"] = new("passwordless-login", "Your NestyStay sign-in link", "Open your secure NestyStay sign-in link: {{actionUrl}}\n\nThis one-time link expires at {{expiresAt}}.", "<h1>Sign in to NestyStay</h1><p><a href=\"{{actionUrl}}\">Continue securely</a></p><p>This one-time link expires at {{expiresAt}}.</p><p>If you did not request this, you can safely ignore this email.</p>"),
            ...
            ["document-expiry"] = new("document-expiry", "A NestyStay document needs attention", "The document {{documentTitle}} in your property-management workspace {{expiryMessage}}. Review it in NestyStay before the deadline.", "<h1>Document expiry reminder</h1><p><strong>{{documentTitle}}</strong> in your property-management workspace {{expiryMessage}}.</p><p>Review the document in NestyStay before the deadline.</p>")
        };
