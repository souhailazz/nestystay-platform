...
public sealed class BookingWorkflowService : IBookingWorkflowService
{
    ...
    [
        ...
        new(3, BookingStatus.PendingVerification, "Identity check", "Guest", "Stripe Identity starts when guest verification is required by the property or selected flow."),
