...
public sealed class PlatformBlueprintService : IPlatformBlueprintService
{
    ...
    [
        ...
        new(ProviderKind.Storage, "Local persistent object storage", ["Encrypted local backup archive"], "Hours", "Private self-hosted storage supports documents, reports and media without a mandatory cloud bucket."),
