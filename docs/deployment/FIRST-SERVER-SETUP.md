...
4. Set strong unique PostgreSQL, Redis, MinIO and application secrets. Set Stripe, the approved identity-provider and Brevo values only in the secret manager.
