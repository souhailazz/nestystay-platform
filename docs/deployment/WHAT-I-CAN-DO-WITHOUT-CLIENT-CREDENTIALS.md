...
- Admin integration health reports PostgreSQL, Redis, MinIO/storage, worker, Brevo, Stripe, Stripe Identity, backups, monitoring, Web Push, and email backlog without exposing secrets.
