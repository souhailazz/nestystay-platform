...
| 02:15 | scripts/backup-object-storage.sh | Private server-local storage archive |
...
storage-root and database connection variables in the scheduler environment. Each script
