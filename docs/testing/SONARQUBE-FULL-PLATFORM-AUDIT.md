...
|---|---:|---:|---:|---:|---:|---:|---|
| `nestystay-backend` | 9 | 31 | 0 | 1009 | 0.0% | 20.6% | FAIL |
| `nestystay-frontend` | 6 | 3 | 0 | 971 | 21.4% | 1.4% | FAIL |
| `nestystay-platform` | 120 | 6 | 0 | 199 | 0.0% | 8.4% | PASS for new-code gate only |

Backend and frontend each have one new violation and fail their new-code gates. Backend also fails new-code coverage at 0.0%. The platform scan has no new violation, but its overall findings are not a clean certification result.
