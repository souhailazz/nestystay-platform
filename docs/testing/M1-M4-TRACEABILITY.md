...
| M3 | Active off-duty JCF officer onboarding; retired/inactive exclusion; admin review lifecycle | Officer self-registration/onboarding, guided 3-step draft/resume wizard with document checklist, availability and privacy consent; admin approve/reject/suspend/reactivate, API tests and 3-viewport browser lifecycle | PASS |
| M3 | Wellness quote, $25–$50 visit pricing, $19 monthly plan with one included visit, parish scheduling and host ownership | Quote/store/controller, subscription start/renew/cancel, live host booking stepper with service comparison and available-officer lookup, persisted visit timeline/cancel-rebook path, 48 API tests and live smoke | PASS |
