...
| Storage | Private server-local file storage with signed API downloads | Configure persistent server volume/ACLs, signing secret, backup, lifecycle and restore policy |
