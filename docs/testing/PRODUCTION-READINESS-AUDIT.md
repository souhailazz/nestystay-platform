...
| Frontend coverage | FAIL | 25.11% honest all-source line coverage; Sonar 21.4% |
| Backend coverage | BLOCKED/FAIL | Sonar imported 0.0% coverage due report-format mismatch |
...
5. Import backend OpenCover coverage, raise frontend coverage honestly, review Sonar bugs/vulnerabilities and reduce the new-violation count to zero.
