...
- Root/orchestration: `codex/frontend-hardening-release-candidate`, audited candidate commit `2c25a70`; the security/code changes are also in integration PR commit `b60c710`.
