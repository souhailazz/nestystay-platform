...
- Root/orchestration: `codex/root-main-integration-current`, security/deployment hardening code commit `ed81c06` (propagated from candidate `de40846`); later commits only pin audit metadata.
